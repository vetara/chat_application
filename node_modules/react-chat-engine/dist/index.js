...
var ChatSettings = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }, topPeople.length === 1 && this.renderOnePerson(topPeople), topPeople.length === 2 && this.renderTwoPeople(topPeople), topPeople.length === 3 && this.renderThreePeople(topPeople)), /*#__PURE__*/React__default.createElement(MessageForm, {
      chat: chat,
      creds: creds
    }));
  };
...
var ChatFeed = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }, this.props.renderChatHeader ? this.props.renderChatHeader(chat) : /*#__PURE__*/React__default.createElement(Title, _extends({
      chat: chat
    ...
    })), this.props.renderNewMessageForm ? this.props.renderNewMessageForm(this.props, activeChat) : /*#__PURE__*/React__default.createElement(MessageForm$1, {
      creds: this.props,
      chatId: activeChat
    }));
  };
